...
<button onclick='orgChart.initTree({id: "#body", data: u_data, modus: "line", loadFunc: loadChilds});'>Classic View</button>
<button onclick='orgChart.initTree({id: "#body", data: u_data, modus: "diagonal", loadFunc: loadChilds});'>Modern View</button>
</div> 
...
function loadChilds(actualElement, successFunction) {
   $.getJSON("/orgchart/" + actualElement.id, 
          function(data) {
...
$.getJSON("/orgchart/0", 
          function(data) {
             u_data = data;
             orgChart.initTree({id: "#body", data: data, modus: "line", loadFunc: loadChilds});
          });
</script>
</body>
</html>
